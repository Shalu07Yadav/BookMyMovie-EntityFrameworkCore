...
public partial class BookMyMovieDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        var connectionString = config.GetConnectionString("BookMyMovieConnection");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Bookings__73951ACDE982BF44");
        ...
        {
            entity.HasKey(e => e.MovieId).HasName("PK__Movies__4BD2943A890A7E16");
        ...
        {
            entity.HasKey(e => e.TheaterId).HasName("PK__Theaters__4D68B2796C2F14C1");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC63880C6F");

            entity.HasIndex(e => e.ContactNumber, "UQ__Users__570665C6AA97A519").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053427AC373B").IsUnique();
